...
# This is simple page for edibility checker
# def app():

#     st.title("Edibility Checker 🍄")
#     st.subheader(f"👀 Not sure if it’s edible? Check with the Edibility Checker! 🍄")
...
#     st.markdown('<div class="footer">Created with ❤️ Strategic Synergists</div>', unsafe_allow_html=True)
